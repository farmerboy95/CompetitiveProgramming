/*
    ...
    Status: AC
    Idea:
        - Use dp, fill letters one by one and maintain the number of matched
        strings with dp[length][state][mask]
        - State can be indexed by an automaton, like Aho-Corasick
*/
