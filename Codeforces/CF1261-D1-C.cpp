/*
    ...
    Status: AC
    Idea:
        - Let dist[i][j] = (distance from (i, j) to the nearest '.') - 1
        - Binary search the result, at each distance d, we assume that all dist[i][j] >= d are trees with fire.
        We simulate the fire incident and compare our forest with the initial forest.
*/
